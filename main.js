...
function init() {
  ...
  // let DIM = LinearDimension.CreateDimensionWithVector(
  //   Point.Origin,
  //   new Point(5, 5, 0),
  //   new Point(1, 3, 0),
  //   Vec
  ...
  //var DIM = new AngularDimension();
  //AngularDimension.AddInstanceAngularDimension(scene, DIM);

  var ArcTest = Arc.CreateArcWithThreePts(
    new Point(2, 2, 0),
    new Point(2, 5, 0),
    new Point(5, 2, 0),
    false
  );
  ArcTest = ArcTest.ExtendArc(0.1, 0.1);
  Arc.AddArcInstance(scene, ArcTest);

  Point.AddPointInstance(scene, new Point(2, 2, 0), 0.2, 0xff0000);
  Point.AddPointInstance(scene, new Point(2, 5, 0), 0.2, 0xff0000);
  Point.AddPointInstance(scene, new Point(5, 2, 0), 0.2, 0xff0000);
